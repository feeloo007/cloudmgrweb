...
class Cloudmgrweb( ICloudMgrResolvers, ICloudMgrComet, ICacheComponents, IDom ):
   def __init__( self ):
      ...
      with self.cloudmap_resolver:
         self._cp_menu_control 		= component.Component( MenuControl( dom_father = self, cache_components = self ) )
